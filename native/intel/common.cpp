...
void init_256(__m128i *rk, unsigned char *uk, bool enc) {
    ...
    if (!enc) {
        ...
        s[0] = rk[14];
        s[1] = _mm_aesimc_si128(rk[13]);
        s[2] = _mm_aesimc_si128(rk[12]);
        s[3] = _mm_aesimc_si128(rk[11]);
        s[4] = _mm_aesimc_si128(rk[10]);
        s[5] = _mm_aesimc_si128(rk[9]);
        s[6] = _mm_aesimc_si128(rk[8]);
        s[7] = _mm_aesimc_si128(rk[7]);
        s[8] = _mm_aesimc_si128(rk[6]);
        s[9] = _mm_aesimc_si128(rk[5]);
        s[10] = _mm_aesimc_si128(rk[4]);
        s[11] = _mm_aesimc_si128(rk[3]);
        s[12] = _mm_aesimc_si128(rk[2]);
        s[13] = _mm_aesimc_si128(rk[1]);
        s[14] = rk[0];

        memcpy(rk, s, sizeof(__m128i) * 15);
        memset(s, 0, sizeof(__m128i) * 15);
    }
...
void init_192(__m128i *rk, unsigned char *uk, bool enc) {
    ...
    if (!enc) {
        __m128i s[13];
        s[0] = rk[12];
        s[1] = _mm_aesimc_si128(rk[11]);
        s[2] = _mm_aesimc_si128(rk[10]);
        s[3] = _mm_aesimc_si128(rk[9]);
        s[4] = _mm_aesimc_si128(rk[8]);
        s[5] = _mm_aesimc_si128(rk[7]);
        s[6] = _mm_aesimc_si128(rk[6]);
        s[7] = _mm_aesimc_si128(rk[5]);
        s[8] = _mm_aesimc_si128(rk[4]);
        s[9] = _mm_aesimc_si128(rk[3]);
        s[10] = _mm_aesimc_si128(rk[2]);
        s[11] = _mm_aesimc_si128(rk[1]);
        s[12] = rk[0];
        memcpy(rk, s, sizeof(__m128i) * 13);
        memset(s, 0, sizeof(__m128i) * 13);

...
[[maybe_unused]] JNIEXPORT void JNICALL Java_org_bouncycastle_crypto_engines_AESNativeGCM_reset
...
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_engines_AESNativeGCM_makeInstance
    ...
    if (encryption == JNI_TRUE) {
        auto instance = new intel::gcm::AesGcm512wideEncrypt();
        return (jlong) instance;
    }

    auto instance = new intel::gcm::AesGcm512wideDecrypt();
    return (jlong) instance;
}
...
JNIEXPORT void Java_org_bouncycastle_crypto_engines_AESNativeGCM_processAADByte

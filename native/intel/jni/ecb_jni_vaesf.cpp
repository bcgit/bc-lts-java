...
JNIEXPORT jlong JNICALL Java_org_bouncycastle_crypto_engines_AESNativeEngine_makeInstance
    ...
    switch (keyLen) {
        case 16:
            if (encryption) {
                instance = new intel::ecb::AesEcb512W128E();
            } else {
                instance = new intel::ecb::AesEcb512W128D();
            }
            break;
        case 24:
            if (encryption) {
                instance = new intel::ecb::AesEcb512W192E();
            } else {
                instance = new intel::ecb::AesEcb512W192D();
            }
            break;
        case 32:
            if (encryption) {
                instance = new intel::ecb::AesEcb512W256E();
            } else {
                instance = new intel::ecb::AesEcb512W256D();
            }
            break;
        default:
            instance = nullptr;

...
namespace intel {
    namespace cfb {
        ...
        void AesCFB128Enc::xform(__m128i data, __m128i *pInt, __m128i &result, __m128i &feedback) {
        ...
        void AesCFB128Dec::init(unsigned char *key) {
            __m128i temp1;
            __m128i temp2;
        ...
        void AesCFB128Dec::xform(__m128i data, __m128i *pInt, __m128i &result, __m128i &feedback) {
            auto tmp = feedback;
            tmp = _mm_xor_si128(tmp, roundKeys[0]);
            tmp = _mm_aesenc_si128(tmp, roundKeys[1]);
            tmp = _mm_aesenc_si128(tmp, roundKeys[2]);

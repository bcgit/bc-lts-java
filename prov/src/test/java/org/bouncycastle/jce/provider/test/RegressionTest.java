...
import org.bouncycastle.jce.provider.test.agreement.JavaNativeAgreementTest;
import org.bouncycastle.jce.provider.test.agreement.JavaNativeLargeMessageTest;
...
public class RegressionTest
{
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Testing " + Security.getProvider("BC").getInfo() + " version: " + Security.getProvider(
                "BC").getVersion());

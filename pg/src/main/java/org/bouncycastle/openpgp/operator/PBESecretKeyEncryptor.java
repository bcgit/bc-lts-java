...
public abstract class PBESecretKeyEncryptor
{
    ...
    // Retained for binary compatibility with pre-existing subclasses that referenced this protected
    // field before the PGPS2KCalculator refactor; populated only on the PGPDigestCalculator constructor
    // path (null for the Argon2/PGPS2KCalculator path, as it was historically).

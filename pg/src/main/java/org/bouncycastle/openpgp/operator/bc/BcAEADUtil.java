        ...
        extends OutputStream
    {
            ...
            throws IOException
        {
            ...
            try
            {
                ...
                // for any bytes the cipher buffers internally plus the MAC, and the native GCM buffers
                // differently from the pure-Java path, so doFinal can need more room than 'data' has.

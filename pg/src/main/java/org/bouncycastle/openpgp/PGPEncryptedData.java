    ...
    implements SymmetricKeyAlgorithmTags, AEADAlgorithmTags
{
        ...
        throws IOException
    {
        ...
        // The check bytes are consumed either way; signalling a mismatch is what makes the CFB quick check the Mister-Zuccherato oracle, so it is done only where PGPSymmetricKeyEncryptedData.isPublicKeyEncrypted() allows it. For SEIPD v1 the MDC is the integrity check.

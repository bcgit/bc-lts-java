...
void sha512_digest(sha512_ctx *ctx, uint8_t *output) {
    ...
    vst1q_u8((uint8_t *) &output[1 * 16], vrev64q_u8(vreinterpretq_u8_u32(ctx->s1)));
    vst1q_u8((uint8_t *) &output[2 * 16], vrev64q_u8(vreinterpretq_u8_u32(ctx->s2)));
    vst1q_u8((uint8_t *) &output[3 * 16], vrev64q_u8(vreinterpretq_u8_u32(ctx->s3)));
...
void hashBlock512(sha512_ctx *ctx, uint8_t *block) {
    ...
    msg0 = vld1q_u8(&block[0 * 16]);
    msg1 = vld1q_u8(&block[1 * 16]);
    msg2 = vld1q_u8(&block[2 * 16]);
    msg3 = vld1q_u8(&block[3 * 16]);
    msg4 = vld1q_u8(&block[4 * 16]);
    msg5 = vld1q_u8(&block[5 * 16]);
    msg6 = vld1q_u8(&block[6 * 16]);
    msg7 = vld1q_u8(&block[7 * 16]);

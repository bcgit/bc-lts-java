...
class RFC3280CertPathUtilities
{
        ...
        throws AnnotatedException
    {
        ...
        for (int i = 0; i < validCerts.size(); i++)
        {
            ...
            if (keyUsage == null)
            {
                if (Properties.isOverrideSet("org.bouncycastle.x509.allow_ca_without_crl_sign") || Properties.getPropertyValue("org.bouncycastle.x509.allow_ca_without_crl_sign") == null)
                {

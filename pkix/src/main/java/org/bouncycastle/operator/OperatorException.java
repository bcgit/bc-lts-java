    ...
    extends Exception
{
    ...
    /**
     * Retained for binary compatibility with the historical LTS API, which declared
     * getCause() explicitly (before the cause was handed to the Throwable superclass).
     * Behaviour is identical to the inherited {@link Throwable#getCause()}.
     */

...
public class SHA512JavaAgreementTest extends TestCase
{
    ...
    private byte[] takeDigest(byte[] message, boolean expectNative) throws Exception
    {
        ...
        if (expectNative)
        {
            TestCase.assertTrue(dig.toString().contains("SHA512[Native]"));
        } else
        {
    ...
    public void testSHA512() throws Exception
    {
        ...
        if (!TestUtil.hasNativeService("SHA512"))
        {
            ...
            {
                TestCase.fail("Skipping SHA512 Agreement Test: " + TestUtil.errorMsg());
            }
            return;
        }

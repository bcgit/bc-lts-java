        ...
        extends TestCase
{
    ...
    public void testVectors()
    {
        ...
        new AESGCMSIV128Test3().exerciseCipher(this);
        new AESGCMSIV256Test1().exerciseCipher(this);
        new AESGCMSIV256Test2().exerciseCipher(this);
        new AESGCMSIV256Test3().exerciseCipher(this);
        new AESGCMSIV256Test4().exerciseCipher(this);
    }
    ...
    public void testExceptions()
    {
        ...
        {
            // expected
            TestCase.assertTrue("wrong message", e.getMessage().contains(ExceptionMessages.AES_KEY_LENGTH_SIV));
        }
     ...
     */
    void exerciseSIVCipher(AESGCMSIVModePacketCipher pCipher,
                           final String pKey,
                           final String pNonce,
                           final String pAEAD,
                           final String pData,
                           final String pExpected)
    {
        ...
        try
        {
            //pCipher = PacketCipherEngine.createGCMSIVPacketCipher();
...
//            pCipher.init(true, myParams);
            ...
            final byte[] myOutput = new byte[pCipher.getOutputSize(true, myParams, myData.length)];
            ...
            pCipher.processPacket(false, myParams, myOutput, 0, myOutput.length, myFinal, 0);

            TestCase.assertTrue("Decryption mismatch", Arrays.areEqual(myData, myFinal));
        }
        catch (PacketCipherException e)
        {
            fail("Bad Text " + e.getMessage());
        }
    }
    ...
    static class AESGCMSIV256Test4
    {
        ...
        void exerciseCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            ...
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_1, EXPECTED_1);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_2, EXPECTED_2);
        }
    }
    ...
    static class AESGCMSIV128Test1
    {
        ...
        private static final String EXPECTED_4 = "743f7c8077ab25f8624e2e948579cf77" +
        ...
        void exerciseCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            ...
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_16, EXPECTED_4);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_32, EXPECTED_5);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_48, EXPECTED_6);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_64, EXPECTED_7);
        }
    }
    ...
    static class AESGCMSIV128Test2
    {
        ...
        private static final String EXPECTED_3 = "e2b0c5da79a901c1745f700525cb335b" +
        ...
        {
            AESGCMSIVModePacketCipher gcmsivPC = AESGCMSIVPacketCipher.newInstance();
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_8, EXPECTED_1);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_12, EXPECTED_2);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_16, EXPECTED_3);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_32, EXPECTED_4);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_48, EXPECTED_5);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_64, EXPECTED_6);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_12, DATA_4, EXPECTED_7);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_18, DATA_20, EXPECTED_8);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_20, DATA_18, EXPECTED_9);
        }
    }
    ...
    static class AESGCMSIV128Test3
    {
        ...
        void exerciseCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            AESGCMSIVModePacketCipher gcmsivPC = AESGCMSIVPacketCipher.newInstance();
            pTest.exerciseSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, EMPTY, EXPECTED_1);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_2, NONCE_2, AEAD_2, DATA_2, EXPECTED_2);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_3, NONCE_3, AEAD_3, DATA_3, EXPECTED_3);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_4, NONCE_4, AEAD_4, DATA_4, EXPECTED_4);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_5, NONCE_5, AEAD_5, DATA_5, EXPECTED_5);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_6, NONCE_6, AEAD_6, DATA_6, EXPECTED_6);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_7, NONCE_7, AEAD_7, DATA_7, EXPECTED_7);
            pTest.exerciseSIVCipher(gcmsivPC, KEY_8, NONCE_8, AEAD_8, DATA_8, EXPECTED_8);
        }
    }
    ...
    static class AESGCMSIV256Test1
    {
        ...
        private static final String EXPECTED_4 = "85a01b63025ba19b7fd3ddfc033b3e76" +
    ...
    static class AESGCMSIV256Test2
    {
        ...
        private static final String EXPECTED_3 = "c91545823cc24f17dbb0e9e807d5ec17" +

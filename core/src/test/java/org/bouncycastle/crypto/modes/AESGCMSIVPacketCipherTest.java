    ...
    extends TestCase
{
     ...
     */
    void testSIVCipher(final AESGCMSIVPacketCipher pCipher,
                       final String pKey,
                       final String pNonce,
                       final String pAEAD,
                       final String pData,
...
//            if (myData.length >= 2)
//            {
//                /* Repeat processing checking processPacket with non-empty internal buffer */
//                pCipher.processByte(myData[0], null, 0);
//                pCipher.processPacket(myData, 1, myData.length - 1, null, 0);
//                pCipher.doFinal(myOutput, 0);
//                TestCase.assertTrue("Encryption mismatch", Arrays.areEqual(myExpected, myOutput));
//            }
//
...
//            pCipher.doFinal(myFinal, 0);
    ...
    static class AESGCMSIV128Test1
    {
        ...
        void testTheCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            ...
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_32, EXPECTED_5);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_48, EXPECTED_6);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, EMPTY, DATA_64, EXPECTED_7);
        }
    }
    ...
    static class AESGCMSIV128Test2
    {
        ...
        void testTheCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            ...
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_32, EXPECTED_4);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_48, EXPECTED_5);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_1, DATA_64, EXPECTED_6);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_12, DATA_4, EXPECTED_7);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_18, DATA_20, EXPECTED_8);
            pTest.testSIVCipher(gcmsivPC, KEY_1, NONCE_1, AEAD_20, DATA_18, EXPECTED_9);
        }
    }
    ...
    static class AESGCMSIV128Test3
    {
        ...
        void testTheCipher(final AESGCMSIVPacketCipherTest pTest)
        {
            ...
            pTest.testSIVCipher(gcmsivPC, KEY_4, NONCE_4, AEAD_4, DATA_4, EXPECTED_4);
            pTest.testSIVCipher(gcmsivPC, KEY_5, NONCE_5, AEAD_5, DATA_5, EXPECTED_5);
            pTest.testSIVCipher(gcmsivPC, KEY_6, NONCE_6, AEAD_6, DATA_6, EXPECTED_6);
            pTest.testSIVCipher(gcmsivPC, KEY_7, NONCE_7, AEAD_7, DATA_7, EXPECTED_7);
            pTest.testSIVCipher(gcmsivPC, KEY_8, NONCE_8, AEAD_8, DATA_8, EXPECTED_8);
        }
    }

...
public class MacThroughputTest
{
    ...
    public static void main(String[] args)
    {
        ...
        testMac(new CMac(new AESEngine()), new KeyParameter(generateNonce(16)), 3);
        testMac(new GMac(new GCMBlockCipher(new AESEngine())), new ParametersWithIV(new KeyParameter(
        ...
        testMac(new Poly1305(new AESEngine()), new ParametersWithIV(generatePoly1305Key(), generateNonce(16)), 1);

    ...
    extends SimpleTest
{
    ...
    static class AESGCMSIV128Test1
    {
        ...
        {
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, EMPTY, EXPECTED_1);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_8, EXPECTED_2);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_12, EXPECTED_3);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_16, EXPECTED_4);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_32, EXPECTED_5);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_48, EXPECTED_6);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_64, EXPECTED_7);
        }
    }
    ...
    static class AESGCMSIV128Test2
    {
        ...
        void testTheCipher(final GCMSIVTest pTest)
        {
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_8, EXPECTED_1);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_12, EXPECTED_2);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_16, EXPECTED_3);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_32, EXPECTED_4);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_48, EXPECTED_5);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_1, DATA_64, EXPECTED_6);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_12, DATA_4, EXPECTED_7);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_18, DATA_20, EXPECTED_8);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, AEAD_20, DATA_18, EXPECTED_9);
        }
    }
    ...
    static class AESGCMSIV128Test3
    {
        ...
        {
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, EMPTY, EXPECTED_1);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_2, NONCE_2, AEAD_2, DATA_2, EXPECTED_2);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_3, NONCE_3, AEAD_3, DATA_3, EXPECTED_3);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_4, NONCE_4, AEAD_4, DATA_4, EXPECTED_4);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_5, NONCE_5, AEAD_5, DATA_5, EXPECTED_5);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_6, NONCE_6, AEAD_6, DATA_6, EXPECTED_6);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_7, NONCE_7, AEAD_7, DATA_7, EXPECTED_7);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_8, NONCE_8, AEAD_8, DATA_8, EXPECTED_8);
        }
    }
    ...
    static class AESGCMSIV256Test4
    {
        ...
        void testTheCipher(final GCMSIVTest pTest)
        {
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_1, EXPECTED_1);
            pTest.testSIVCipher(GCMSIVBlockCipher.newInstance(AESEngine.newInstance()), KEY_1, NONCE_1, EMPTY, DATA_2, EXPECTED_2);
        }
    }

    ...
    extends TestCase
{
    ...
    /**
     * The HSS index and each component key's own one-time index are two records of the same
     * position in the key; a decoded key whose records disagree - here, an index rolled back
     * to 0 while the component key stayed advanced - is refused rather than silently accepted
     * (github #2414).
     */

...
public final class CryptoServicesRegistrar
{
            ...
            implements EntropySource
    {
                            ...
                            final int bitsRequired)
        {
            ...
            drbg = new HMacSP800DRBG(new HMac(new SHA512Digest()), 256, entropySource, Strings.toByteArray("Bouncy " +
                    "Castle Hybrid Entropy Source"), entropySource.getEntropy());
        }
            ...
            implements EntropySource
    {
        ...
        OneShotHybridEntropySource(EntropySourceProvider entropyProvider, final int bitsRequired)
        {
            ...
            drbg = new HMacSP800DRBG(new HMac(new SHA512Digest()), 256, entropySource, Strings.toByteArray("Bouncy " +
                    "Castle One Shot Entropy Source"), entropySource.getEntropy());
        }

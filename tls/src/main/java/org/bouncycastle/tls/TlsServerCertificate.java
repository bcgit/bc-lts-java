...
public interface TlsServerCertificate
{
     ...
     * response is held).
     * <p/>
     * The default implementation only knows about index 0, via {@link #getCertificateStatus()} -
     * an implementation outside this library predates per-certificate stapling and cannot be
     * expected to know about any other index.
     *
     ...
     */
    default CertificateStatus getCertificateStatusAt(int index)
    {
        return 0 == index ? getCertificateStatus() : null;
    }
}
